...
class User extends \CsnUser\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'firstName', 'lastName', 'apellidoMaterno', 'calle', 'numeroExt', 'numeroInt', 'colonia', 'codigoPostal', 'telefono1', 'telefono2', 'municipios', 'estado', 'email', 'password', 'role', 'language', 'state', 'question', 'answer', 'picture', 'registrationDate', 'registrationToken', 'emailConfirmed');
        }
    ...
    public function setNumeroExt($numeroExt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumeroExt', array($numeroExt));
